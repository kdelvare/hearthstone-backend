...
namespace :db do
	...
	task populate_enums: :environment do
		...
		Cardset.create(hs_id: 21, name: 'OG', name_fr: 'Les Murmures des Dieux très anciens', collectible: true, standard: false)
		Cardset.create(hs_id: 22, name: 'OG reserve', name_fr: '', collectible: false, standard: false)
		Cardset.create(hs_id: 23, name: 'KARA', name_fr: 'Une nuit à Karazhan', collectible: true, standard: false)
		Cardset.create(hs_id: 24, name: 'KARA reserve', name_fr: 'KARA reserve', collectible: false, standard: false)
		Cardset.create(hs_id: 25, name: 'GANGS', name_fr: 'Main basse sur Gadgetzan', collectible: true, standard: false)
		Cardset.create(hs_id: 26, name: 'GANGS reserve', name_fr: 'GANGS reserve', collectible: false, standard: false)
		Cardset.create(hs_id: 27, name: 'UNGORO', name_fr: 'Voyage au centre d’Un’Goro', collectible: true, standard: true)
		Cardset.create(hs_id: 1001, name: 'Ice crown', name_fr: 'Chevaliers du Trône de glace', collectible: true, standard: true)
		Cardset.create(hs_id: 1004, name: 'Lootapalooza', name_fr: 'Kobolds et catacombes', collectible: true, standard: true)
		Cardset.create(hs_id: 1125, name: 'Gilneas', name_fr: 'Bois Maudit', collectible: true, standard: true)
		Cardset.create(hs_id: 1127, name: 'Boomsday', name_fr: 'Projet Armageboum', collectible: true, standard: true)
		Cardset.create(hs_id: 1129, name: 'Rastakhan', name_fr: 'Jeux de Rastakhan', collectible: true, standard: true)
