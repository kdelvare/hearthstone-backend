...
namespace :db do
	...
	task populate_enums: :environment do
		...
		ym = Year.create(name: 'Year of the Mammoth', name_fr: 'Année du Mammouth', standard: false)
		yr = Year.create(name: 'Year of the Raven', name_fr: 'Année du Corbeau', standard: true)
		yd = Year.create(name: 'Year of the Dragon', name_fr: 'Année du Dragon', standard: true)
		...
		Cardset.create(hs_id: 27, name: 'UNGORO', name_fr: 'Voyage au centre d’Un’Goro', collectible: true, standard: false, year_id: ym.id)
		Cardset.create(hs_id: 1001, name: 'Ice crown', name_fr: 'Chevaliers du Trône de glace', collectible: true, standard: false, year_id: ym.id)
		Cardset.create(hs_id: 1004, name: 'Lootapalooza', name_fr: 'Kobolds et catacombes', collectible: true, standard: false, year_id: ym.id)
